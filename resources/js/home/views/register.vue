<template>
    <div class="container flexBox">
        <div class="blackBox">
            ...
            <Form @submit="register" ref="form" :validation-schema="schema" class="form inner" v-slot="{ errors }">
                <div class="inputDiv">
                ...
                <div class="inputDiv">
                    ...
                    <Field class="form-control" name="name" autocomplete="username" type="text"
